    ...
    <div className="flex-1 space-y-4">
        ...
        <Card key={index}>
            ...
            <div className="flex flex-col">
                ...
                {/* Expand when click on the button */}
                {expandedFlight === index && expandedClass === 'economy' && (
                <div className="mt-4 border-t pt-4">
                    <h3 className="font-semibold mb-4">Chọn giá vé</h3>
                    <div className="grid md:grid-cols-2 gap-4">
                    {flight.economyOptions.map((option, optionIndex) => (
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div>
                                ...
                                <div className="text-gray-600">Phí đổi vé tối đa {option.changeFee.toLocaleString()} VND mỗi hành khách</div>
                            </div>
                            </div>
                            <div className="flex items-start gap-2">
                            <RefreshCw className="h-4 w-4 mt-1" />
                            <div>
                                ...
                                <div className="text-gray-600">Phí hoàn vé tối đa {option.refundFee.toLocaleString()} VND mỗi hành khách</div>
                            </div>
                            </div>
                            <div className="flex items-start gap-2">
                ...
                {expandedFlight === index && expandedClass === 'business' && (
                <div className="mt-4 border-t pt-4">
                    <h3 className="font-semibold mb-4">Chọn giá vé</h3>
                    <div className="grid md:grid-cols-2 gap-4">
                    {flight.businessOptions.map((option, optionIndex) => (
                        <div key={optionIndex} className="border rounded-lg p-4 relative">
                        <div className="text-lg font-semibold mb-2">{option.name}</div>
                        <div className="text-xl font-bold text-teal-700 mb-4">
                            {option.price.toLocaleString()} VND
